<template>
  <v-container>
    ...
    <v-card-actions v-if="canEdit">
      ...
      <v-btn ref="saveBtn" depressed @click="saveChanges" :loading="loading" v-if="editMode" color="primary">Save
      </v-btn>
    </v-card-actions>
  </v-container>
</template>
...
import SettingEditInfoLoader from "@/components/workspaces/SettingEditInfoLoader";

export default {
  name: "SettingEditInfo",
  components: {SettingEditInfoLoader},
  data() {
    return {
      info: {},
      editMode: false,
